...
from pygobnilp.gobnilp import DiscreteBIC, DiscreteData, GaussianBIC, ContinuousData
...
class reward_BIC:
    def __init__(self, sample_datas, node_size):
        ...
        # self.gobdata = ContinuousData(data=self.data.values, varnames=self.data.columns)
        # self.gobscore = GaussianBIC(self.gobdata)
